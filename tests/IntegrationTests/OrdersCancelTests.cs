...
public class OrdersCancelTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;
    public OrdersCancelTests(WebApplicationFactory<Program> factory) => _factory = factory;
    ...
    public async Task Cancel_pending_should_return_204_and_set_status_cancelled()
    {
        ...
        var req = new HttpRequestMessage(HttpMethod.Put, $"/api/v1/orders/{orderId}/cancel");
        req.Headers.Add("X-Test-Bypass-RateLimit", "1");
